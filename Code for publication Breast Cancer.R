...
Comorb_Breast<- MasterTab %>% dplyr::filter(grepl("C50", ICD10CDS)==T)
#Preprocess Breast Cancer Data ####

#Prediagnosis

Diabetic_Breast_Tab<- Comorb_Breast %>% 
...
BloodNumber <- sum(Diabetic_Breast_Tab$BloodDiabetic)#Number of prediagnosis Diagnostic HBA1c
HesNumber<- sum(Diabetic_Breast_Tab$HESDiabetic)# Number of coded diabetics
AllNumber<- sum(Diabetic_Breast_Tab$AnyDiabetes) # Number of diabetics including HBA1c and Coding
BothNumber<- nrow(dplyr::filter(Diabetic_Breast_Tab, HESDiabetic ==1 & BloodDiabetic ==1)) # Number with both blood and coding
AllCancer<- nrow(Diabetic_Breast_Tab) # Number of PAtients in total
...
# Post Diangosis
#Identification of Diabetic PAtients Using Each method in Breast Cancer

Diabetic_Breast_Tab<- Diabetic_Breast_Tab %>% dplyr::mutate( Late.HESDiabetic = ifelse( Late.T1Diabetes == 1|
                                                                                          Late.T2Diabetes ==1|
                                                                                          Late.OtherDiabetes == 1, 1, 0),
                                                             Late.BloodDiabetic = Late.Diagnostic) # add label for late effect clinical coding and bloods

Late.BloodNumber <- sum(Diabetic_Breast_Tab$Late.BloodDiabetic, na.rm = T) #number of late blood diabetics
Late.HesNumber<- sum(Diabetic_Breast_Tab$Late.HESDiabetic, na.rm = T) # number of late coded diabetics
Late.AllNumber<- sum(Diabetic_Breast_Tab$Late.AnyDiabetes) # total number of late diabetics
Late.BothNumber<- nrow(dplyr::filter(Diabetic_Breast_Tab, Late.HESDiabetic ==1 & Late.BloodDiabetic ==1)) # number of diabetics with both
AllCancer<- nrow(Diabetic_Breast_Tab) # total number of patients
...
Diabetic_Breast_Tab<- Diabetic_Breast_Tab %>% dplyr::mutate( TotalHESDiabetic = ifelse( T1Diabetes == 1|
                                                                                          T2Diabetes ==1|
                                                                                          OtherDiabetes == 1 |
                                                                                          Late.T1Diabetes ==1| 
                                                                                          Late.T2Diabetes ==1|
...
TotalBloodNumber <- sum(Diabetic_Breast_Tab$TotalBloodDiabetic, na.rm = T)
TotalHesNumber<- sum(Diabetic_Breast_Tab$TotalHESDiabetic)
TotalAllNumber<- sum(Diabetic_Breast_Tab$TotalAnyDiabetes)
TotalBothNumber<- nrow(dplyr::filter(Diabetic_Breast_Tab, TotalHESDiabetic ==1 & TotalBloodDiabetic ==1))
...
AllBloodOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab, (Diagnostic == 1 | Late.Diagnostic == 1) &
                                    T1Diabetes == 0 & T2Diabetes ==0 & OtherDiabetes ==0 &
                                    Late.T1Diabetes ==0 & Late.T2Diabetes ==0 & Late.OtherDiabetes ==0))

AllCodedOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 |
                                                         Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                    Diagnostic == 0 & Late.Diagnostic == 0 ))

AllBoth <- nrow(dplyr::filter(Diabetic_Breast_Tab,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 |
                                                     Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                (Diagnostic == 1 | Late.Diagnostic == 1 )))


PreBloodOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab, (Diagnostic == 1 ) &
                                    T1Diabetes == 0 & T2Diabetes ==0 & OtherDiabetes ==0))

PreCodedOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 ) &
                                    Diagnostic == 0 ))

PreBoth <- nrow(dplyr::filter(Diabetic_Breast_Tab,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 ) &
                                (Diagnostic == 1 )))


PostBloodOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab, (Late.Diagnostic == 1) &
                                     Late.T1Diabetes ==0 & Late.T2Diabetes ==0 & Late.OtherDiabetes ==0))

PostCodedOnly<- nrow(dplyr::filter(Diabetic_Breast_Tab,( Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                     Late.Diagnostic == 0 ))

PostBoth <- nrow(dplyr::filter(Diabetic_Breast_Tab, (Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                 Late.Diagnostic == 1 ))
...
Diabetic_Breast_Tab<- Diabetic_Breast_Tab %>%
  dplyr::mutate(Sex_Label = ifelse(Sex == 781, "Female", "Male")) 

HBA1C_Pre<- Diabetic_Breast_Tab%>% dplyr::filter(Diagnostic == 1)
Coded_Pre<- Diabetic_Breast_Tab%>% dplyr::filter(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes == 1,
                                                 is.na(Sex_Label)==F)
Any_Pre<- Diabetic_Breast_Tab%>% dplyr::filter(AnyDiabetes == 1,
                                               is.na(Sex_Label)==F)
...
Unique_HBA1c<- Diabetic_Breast_Tab %>%
...
Unique_Coding<- Diabetic_Breast_Tab %>%
...
Both_Identified<- Diabetic_Breast_Tab %>%
  dplyr::filter(Diagnostic==1 &
                  (T1Diabetes == 1 |
                     T2Diabetes == 1 |
                     OtherDiabetes == 1),is.na(Sex_Label)==F)%>%
...
All_Surv <- Surv(time = Diabetic_Breast_Tab$SurvivalTime/365, event = Diabetic_Breast_Tab$SurvivalStatus)

HBA1c_KMFit<- survfit(All_Surv ~ Diagnostic  , data = Diabetic_Breast_Tab)
HBA1c_KM<- ggsurvplot(HBA1c_KMFit, data = Diabetic_Breast_Tab, risk.table = T,
                      legend.title = "",
...
Coded_KMFit<- survfit(All_Surv ~ HESDiabetic  , data = Diabetic_Breast_Tab)
Coded_KM<- ggsurvplot(Coded_KMFit, data = Diabetic_Breast_Tab, risk.table = T,
                      legend.title = "",
...
Any_KMFit<- survfit(All_Surv ~ AnyDiabetes  , data = Diabetic_Breast_Tab)
Any_KM<- ggsurvplot(Any_KMFit, data = Diabetic_Breast_Tab, risk.table = T,
                    legend.title = "",
...
HESGroup<- Diabetic_Breast_Tab %>% dplyr::filter (HESDiabetic ==1) %>%
  dplyr::mutate(SurvivalComp = "HES Only")
BloodsGroup<- Diabetic_Breast_Tab %>% dplyr::filter (Diagnostic ==1) %>%
  dplyr::mutate(SurvivalComp = "Bloods Only")
BothGroup<- Diabetic_Breast_Tab %>% dplyr::filter (Diagnostic ==1 | HESDiabetic ==1) %>%
  dplyr::mutate(SurvivalComp = "Both")
AllCancers<- Diabetic_Breast_Tab%>% dplyr::mutate(SurvivalComp = "All Cancer Patients")
...
Comp_KM<- ggsurvplot(Comp_KMFit, data = Surv_Comp_Tab, risk.table = T,
                     ...
                     legend.labs = c("All Breast Cancer Patients", "HBA1c Only Diabetics", "Hybrid Definition Diabetics ", "Clinical Coding Only Diabetics"),
                     surv.median.line = "hv"  ,
                     font.x = c(30),
                     font.y = c(30),
...
Cox_Comp<- ggsurvplot_combine(fit = list(Cox_HES, Cox_Bloods, Cox_Both, Cox_All), 
                              data = Diabetic_Breast_Tab,
                              risk.table = T,
                              legend.title = "",
                              legend.labs = c("Clinical Coding Only Diabetics", "HBA1c Only Diabetics", "Hybrid Definition Diabetics ", "All Breast Cancer Patients" ),
                              conf.int = T,
                              censor.shape= NA,
                              xlim= c(0,10),
                              ggtheme = theme_bw(),
...
BothDiab<- Diabetic_Breast_Tab%>% dplyr::filter((Diagnostic == 1 | Late.Diagnostic ==1) & 
...
Volume_Breast<- inner_join(Diabetic_Breast_Tab , Volume_Patients, by = c("Study_ID"))

# Create Tables for patient numbers by method of identification 

AllBloodOnly2<- nrow(dplyr::filter(Volume_Breast, (Diagnostic == 1 | Late.Diagnostic == 1) &
                                     T1Diabetes == 0 & T2Diabetes ==0 & OtherDiabetes ==0 &
                                     Late.T1Diabetes ==0 & Late.T2Diabetes ==0 & Late.OtherDiabetes ==0))

AllCodedOnly2<- nrow(dplyr::filter(Volume_Breast,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 |
                                                    Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                     Diagnostic == 0 & Late.Diagnostic == 0 ))

AllBoth2 <- nrow(dplyr::filter(Volume_Breast,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 |
                                                Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                 (Diagnostic == 1 | Late.Diagnostic == 1 )))


PreBloodOnly2<- nrow(dplyr::filter(Volume_Breast, (Diagnostic == 1 ) &
                                     T1Diabetes == 0 & T2Diabetes ==0 & OtherDiabetes ==0))

PreCodedOnly2<- nrow(dplyr::filter(Volume_Breast,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 ) &
                                     Diagnostic == 0 ))

PreBoth2 <- nrow(dplyr::filter(Volume_Breast,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 ) &
                                 (Diagnostic == 1 )))


PostBloodOnly2<- nrow(dplyr::filter(Volume_Breast, (Late.Diagnostic == 1) &
                                      Late.T1Diabetes ==0 & Late.T2Diabetes ==0 & Late.OtherDiabetes ==0))

PostCodedOnly2<- nrow(dplyr::filter(Volume_Breast,( Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                      Late.Diagnostic == 0 ))

PostBoth2 <- nrow(dplyr::filter(Volume_Breast, (Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                  Late.Diagnostic == 1 ))
...
ggsave(FilteredIdentification_Pie,file = "F:/CPR/R Script/Chapter 4 - S/HBA1c Enhancement Results/Plots/Breast/Filtered Pie.jpeg", width = 60, height = 30, units = "cm")
fwrite(Filtered_Pie_Tab, file = "F:/CPR/R Script/Chapter 4 - S/HBA1c Enhancement Results/Plots/Breast/Filtered Pie Numbers.csv")


#identify Patients with coding only and no HBA1c tests ever

Filtered_Coding_Only<- dplyr::filter(Volume_Breast,(T1Diabetes == 1 | T2Diabetes ==1 | OtherDiabetes ==1 |
                                                      Late.T1Diabetes ==1 | Late.T2Diabetes ==1 | Late.OtherDiabetes ==1) &
                                       (Diagnostic == 0 | Late.Diagnostic == 0 )) %>%
